...
Se $SE_{AUB}=SE_A + SE_B + SE_{A \cap B}$, per rispettare l'assunzione occorre impostare i parametri tali che:
...
```{r example_old, echo=TRUE , eval=FALSE}
...
```{r example_data_table, echo=TRUE , eval=FALSE}
